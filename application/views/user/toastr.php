...
<body>
	<body>
			...
			<div id="wrapper">
				<div class="header">
            		<img src="<?=base_url('assets/img/logo/evoting.png')?>"alt="logo" width="200px" height="65px"/>
					<img src="<?=base_url('assets/img/logo/home1.png')?>" style="float:right" alt="welcome" width="55px"/>
					<h3 style="float:right">Selamat Datang</h3>
				</div>	
				<div id="content">
				<tr>
				<td width="50%">
				...
				<td width="50%">
					...
					<div class="login">
						...
						<div class="grup">
							...
							<button type="submit" class="tombol_login toastrDefaultInfo">NEXT</button>
							</form>
						</div>
				...
				<div class="footer">
					<h4>Copyright &copy2019 E-VOTING KEPALA DESA</h4>
				</div>
				</div>
        </div>
