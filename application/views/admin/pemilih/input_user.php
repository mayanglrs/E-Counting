...
<body>
    		...
    		<ul class="nav navbar-nav">
    			...
    			<li class="dropdown">
			        ...
			        <ul class="dropdown-menu">
			          	<li class="active"><a href="<?=base_url('admin/input_user')?>">Input Pemilih</a></li>
	...
	<div class="container">
	  <form class="form-horizontal" action="<?=base_url('admin/input_user')?>" method="post" enctype="multipart/form-data">
