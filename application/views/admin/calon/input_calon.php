...
<body>
 		...
 		<div class="container-fluid">
    		...
    		<ul class="nav navbar-nav">
			    ...
			    <li class="dropdown">
			        ...
			        <span class="caret"></span></a>
			        <ul class="dropdown-menu">
			          	<li class="active"><a href="<?=base_url('admin/input_calon')?>">Input Calon</a></li>
			    ...
			    <li class="dropdown">
			        ...
			        <span class="caret"></span></a>
			        <ul class="dropdown-menu">
			          	<li><a href="<?=base_url('admin/input_petugas')?>">Input Petugas</a></li>
	...
	<div class="container">
	<h1 align="center">Input Calon</h1>
	  <form class="form-horizontal" action="<?=base_url('admin/input_calon')?>" method="post" enctype="multipart/form-data">
