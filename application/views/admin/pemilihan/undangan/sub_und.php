                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <?php foreach($data_pemilih as $pm):?>
                        <option value="<?php echo $pm->nama ?>"><?php echo $pm->nama ?></option>
                      <?php endforeach;?>      
                      </select>
                        </div>
                      ...
                      <label for="nik">Ketua</label>
                       <select class="form-control select2" style="width: 100%;" name="ketua">
                        ...
                        <?php foreach($data_petugas as $pm):?>
                          <option value="<?php echo $pm->nama_petugas ?>"><?php echo $pm->nama_petugas ?></option>
                        <?php endforeach;?>      
                      </select>
                    </div>
                    <div class="form-group">
                      <label for="nik">Petugas Pengantar Undangan</label>
                         <select class="form-control select2" style="width: 100%;" name="pengantar">
                          <option selected="selected"></option>
                          <?php foreach($data_petugas as $pm):?>
                            <option value="<?php echo $pm->nama_petugas ?>"><?php echo $pm->nama_petugas ?></option>
                          <?php endforeach;?>      
