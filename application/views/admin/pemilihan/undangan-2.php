...
<body>
	...
	<div class="container">
	  <form class="form-horizontal" action="<?=base_url('pemilihan/undangan/').$data_pemilih->id;?>" method="post" enctype="multipart/form-data">
	    <div class="form-group">
	      <label class="control-label col-sm-2" for="nama">Nama:</label>
	      <div class="col-sm-10">
	        <label class="form-control" id="nama" name="nama"><?=$data_pemilih['nama'];?></label>
	      </div>
	    </div>
	    <div class="form-group">
	      ...
	      <div class="col-sm-10">
	        <select class="form-control" name="jenis_pm" id="jenis_pm">
	        	...
	        	<?php foreach($data_pemilihan->result_array() as $jenis):?>
